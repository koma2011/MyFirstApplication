package com.koma.weather.view.adapter;
...
import com.koma.weather.model.Setting;
import com.koma.weather.model.Weather;
import com.koma.weather.utils.Util;
import com.koma.weather.utils.image.ImageLoader;
 ...
 */
public class WeatherAdapter extends BaseAdapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Logger.i(TAG, "onCreateViewHodler viewType : " + viewType);
        switch (viewType) {
            case TYPE_ONE:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Logger.i(TAG, "onBindViewHolder itemType : " + itemType);
        switch (itemType) {
            case TYPE_ONE:
    ...
    public int getItemCount() {
        if (mWeatherData.status != null) {
            Logger.i(TAG, "getItemCount mWeatherData.status != null");
        }
